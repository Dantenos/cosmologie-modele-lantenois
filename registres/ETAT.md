...
- **Critères gelés** : 57 (`outils/registre.lock`) — 0 amendé (`RETRACTATIONS.md`)
- **Registre** : 170 entrées numérotées (`INDEX_MANQUEMENTS.md`)
...
- **Scripts** : 65 dans `scripts/` ; **outils** : 19 dans `outils/`
