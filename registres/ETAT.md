...
- **Critères gelés** : 53 (`outils/registre.lock`) — 0 amendé (`RETRACTATIONS.md`)
- **Registre** : 168 entrées numérotées (`INDEX_MANQUEMENTS.md`)
...
- **Scripts** : 61 dans `scripts/` ; **outils** : 19 dans `outils/`
