...
\author{\'Edouard Lantenois\thanks{Independent researcher, Lille, France. Prepared with AI assistance (Claude, Anthropic); all load-bearing numbers verified against the cited sources; source status is labelled per row (sourced / order-of-magnitude / bounded / demoted).}}
\date{August 19, 2026 --- v1 (v0: Aug.\ 18; adds the viability diagram, the strategy taxonomy, the deprivation campaign and six new systems; demotes one)}
\begin{document}
\maketitle
\begin{abstract}
...
Twelve counted systems spanning $\sim$32 orders of magnitude of mass give $x \in [0.37, 1.95]$
...
\section{Data: twelve members, two controls, exclusions}
