...
- **Critères gelés** : 75 (`outils/registre.lock`) — 0 amendé (`RETRACTATIONS.md`)
- **Registre** : 194 entrées numérotées (`INDEX_MANQUEMENTS.md`)
...
- **Scripts** : 73 dans `scripts/` ; **outils** : 30 dans `outils/`
