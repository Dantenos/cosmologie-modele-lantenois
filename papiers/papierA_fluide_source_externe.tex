...
$-23.49$ at $\delta = +0.04$~mag, i.e.\ a $\sim 30$-unit swing for a plausible systematic against a
...
published inter-compilation disagreements), i.e.\ \textbf{about half of the evolving-$w$ gain is purchasable
by recalibration alone}. It does not, however, dissolve the signal: at equal parameter count, the
...
$1402.3$; $\Lambda$CDM $1402.7$) with a reduced margin. The low-$z$ signal therefore decomposes into roughly half calibration-absorbable and half
...
\emph{suppresses} growth relative to $\Lambda$CDM --- the cleanest available falsification channel,
already measurable with existing redshift-space-distortion compilations. Until these are computed, the
...
(added in revision).} We have quoted $z \simeq 0.46$ for the $w = -1$ crossing throughout. That
...
$z \simeq 0.46$ as a quoted prediction} and retain only that the crossing occurs at low redshift.
...
The test becomes decisive with sample size, since $\Delta\chi^2$ scales with it: $142$ localized
bursts for $3\sigma$, $253$ for $4\sigma$, $395$ for $5\sigma$. The published samples have gone
...
\bibitem{Croker2024} K.~S.~Croker, G.~Tarl\'e, S.~P.~Ahlen, B.~G.~Cartwright, D.~Farrah, N.~Fernandez, R.~A.~Windhorst, \emph{DESI dark energy time evolution is recovered by cosmologically coupled black holes}, JCAP \textbf{10}, 094 (2024), arXiv:2405.12282.
