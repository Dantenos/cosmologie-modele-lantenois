...
- **Critères gelés** : 46 (`outils/registre.lock`) — 0 amendé (`RETRACTATIONS.md`)
- **Registre** : 161 entrées numérotées (`INDEX_MANQUEMENTS.md`)
...
- **Scripts** : 57 dans `scripts/` ; **outils** : 17 dans `outils/`
