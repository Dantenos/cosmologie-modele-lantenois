...
- **Critères gelés** : 52 (`outils/registre.lock`) — 0 amendé (`RETRACTATIONS.md`)
- **Registre** : 167 entrées numérotées (`INDEX_MANQUEMENTS.md`)
...
- **Scripts** : 61 dans `scripts/` ; **outils** : 18 dans `outils/`
