...
- **Critères gelés** : 69 (`outils/registre.lock`) — 0 amendé (`RETRACTATIONS.md`)
- **Registre** : 182 entrées numérotées (`INDEX_MANQUEMENTS.md`)
...
- **Scripts** : 71 dans `scripts/` ; **outils** : 25 dans `outils/`
