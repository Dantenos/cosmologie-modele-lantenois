...
- **Critères gelés** : 74 (`outils/registre.lock`) — 0 amendé (`RETRACTATIONS.md`)
- **Registre** : 192 entrées numérotées (`INDEX_MANQUEMENTS.md`)
...
- **Scripts** : 72 dans `scripts/` ; **outils** : 30 dans `outils/`
