...
- **Critères gelés** : 88 (`outils/registre.lock`) — 0 amendé (`RETRACTATIONS.md`)
- **Registre** : 204 entrées numérotées (`INDEX_MANQUEMENTS.md`)
- **Triage** : 10 attaques justes, 70 affirmations réfutées (dernier bilan)
- **Affaires au rôle** : 4 (DR3-beta, FRB-s, W-universel, k3-vs-0)
- **Données publiques** : 21 fichiers sous empreinte (`donnees/SHA256SUMS`)
- **Scripts** : 82 dans `scripts/` ; **outils** : 34 dans `outils/`
