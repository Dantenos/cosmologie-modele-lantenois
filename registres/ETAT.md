...
- **Critères gelés** : 73 (`outils/registre.lock`) — 0 amendé (`RETRACTATIONS.md`)
- **Registre** : 185 entrées numérotées (`INDEX_MANQUEMENTS.md`)
...
- **Scripts** : 72 dans `scripts/` ; **outils** : 29 dans `outils/`
