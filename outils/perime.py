...
FACADE = ["README.md", "CLAUDE.md", "RETRACTATIONS.md", "outils/README_registre.md",
          ...
          "visuels/ciel_pantheon.html", "visuels/mur_retractations.html", "visuels/saga_du_bord.html", "visuels/video_explicative.html"]
