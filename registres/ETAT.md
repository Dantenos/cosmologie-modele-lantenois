...
- **Critères gelés** : 87 (`outils/registre.lock`) — 0 amendé (`RETRACTATIONS.md`)
- **Registre** : 202 entrées numérotées (`INDEX_MANQUEMENTS.md`)
- **Triage** : 10 attaques justes, 67 affirmations réfutées (dernier bilan)
- **Affaires au rôle** : 4 (DR3-beta, FRB-s, W-universel, k3-vs-0)
- **Données publiques** : 21 fichiers sous empreinte (`donnees/SHA256SUMS`)
- **Scripts** : 81 dans `scripts/` ; **outils** : 34 dans `outils/`
