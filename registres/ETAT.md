...
- **Critères gelés** : 59 (`outils/registre.lock`) — 0 amendé (`RETRACTATIONS.md`)
- **Registre** : 176 entrées numérotées (`INDEX_MANQUEMENTS.md`)
...
- **Scripts** : 67 dans `scripts/` ; **outils** : 19 dans `outils/`
