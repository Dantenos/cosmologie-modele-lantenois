...
- **Critères gelés** : 65 (`outils/registre.lock`) — 0 amendé (`RETRACTATIONS.md`)
- **Registre** : 179 entrées numérotées (`INDEX_MANQUEMENTS.md`)
...
- **Scripts** : 70 dans `scripts/` ; **outils** : 22 dans `outils/`
