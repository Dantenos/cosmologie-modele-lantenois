...
- **Critères gelés** : 71 (`outils/registre.lock`) — 0 amendé (`RETRACTATIONS.md`)
- **Registre** : 183 entrées numérotées (`INDEX_MANQUEMENTS.md`)
...
- **Scripts** : 72 dans `scripts/` ; **outils** : 27 dans `outils/`
